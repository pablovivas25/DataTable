...
<body class="sidebar-fixed topnav-fixed demo-only-page-blank">
			...
			<div class="content">
				...
				<div class="main-content">
					<div class="widget widget-table">
						...
						<!--	<table id="id_clientes" class="table table-sorting table-hover table-bordered datatable">
								<thead>
									<tr>
										<th>Cliete_codigo</th>
										<th>Apellido</th>
						...
						-->
							<?php include("C:\xampp\htdocs\kingadmin heme\Datatable\datatablecliente.html");?>
						</div>
					</div>
				</div>
			</div>
	...
	<script src="js/datatableserver.js"></script>
    <script src="scripts/serverside.php"></script>

  
  <!--  <script src="scripts/ssp.class2.php"></script>-->
</body>
